...
-- Split screen and show effects of commands
...
-- Buffers
vim.keymap.set({ 'n', 'v', 'i' }, '<A-,>', ':bp<CR>')
vim.keymap.set({ 'n', 'v', 'i' }, '<A-.>', ':bn<CR>')
vim.keymap.set({ 'n', 'v', 'i' }, '<A-c>', ':bd<CR>')

-- Code Format
vim.keymap.set('n', '<leader>F', vim.lsp.buf.format)

-- RelativeNum toggle
local rNumToggle = function()
...
vim.keymap.set('n', '<leader>r', rNumToggle)
...
-- [[ Trim whitespaces ]]
local trimmer = function(patterns)
